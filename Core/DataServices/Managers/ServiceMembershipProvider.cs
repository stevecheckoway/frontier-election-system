// -----------------------------------------------------------------------------
// <copyright file="ServiceMembershipProvider.cs" company="Sequoia Voting Systems"> 
//     Copyright (c) 2010 Sequoia Voting Systems, Inc. All Rights Reserved.
//     Distribution of source code is allowable only under the terms of the
//     license agreement found at http://www.sequoiavote.com/license.html
// </copyright>
// <summary>
//     This file contains the ServiceMembershipProvider class.
// </summary>
// <revision revisor="dev14" date="1/22/2010" version="1.1.5.19">
//     File Created
// </revision>  
// -----------------------------------------------------------------------------
...
namespace Sequoia.EMS.Core
{
    ...
    /// <summary>
    ///	    ServiceMembershipProvider implements the Micorosft Membership
    ///     provider. Its goal is to allow us to use the standard Security
    ...
    ///     the existing app secuirty model.
    /// </summary>
    /// <externalUnit/>
    /// <revision revisor="dev14" date="1/22/2010" version="1.1.5.19">
    ///     Class created.
    ...
    public class ServiceMembershipProvider : MembershipProvider
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ServiceMembershipProvider"/> class.
        /// </summary>
        /// <externalUnit/>
        /// <revision revisor="dev14" date="1/22/2010" version="1.1.5.19">
        ///     Member Created
        /// </revision>	
        public ServiceMembershipProvider()
        {
            this.dataService = new UserDataService();
            this.dataService.SetDefinition(DataManager.Instance.DataServiceDefinition);
        }
        ...
        #region Implementation of MembershipProvider
        ...
        /// </summary>
        /// <returns>
        ///     [true] if the membership provider supports password reset; 
        ...
        ///     configured to require the user to answer a password question for 
        ///     password reset and retrieval.
        /// </summary>
        /// <returns>
        ///     [true] if a password answer is required for password reset and 
        ///     retrieval; otherwise, [false]. The default is true.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     [true] if the membership provider requires a unique e-mail 
        ///     address; otherwise, [false]. The default is true.
        /// </returns>
        ...
        ///     values indicating the format for storing passwords in the 
        ///     data store.
        /// </returns>
        ...
        ///     The unique identifier from the membership data source for the 
        ///     user.
        /// </param>
        /// <param name="status">
        ///     A <see cref="T:System.Web.Security.MembershipCreateStatus" /> 
        ///     enumeration value indicating whether the user was created 
        ///     successfully.
        /// </param>
        ...
        /// </summary>
        /// <returns>
        ///     [true] if the password question and answer are 
        ///     updated successfully; otherwise, [false].
        /// </returns>
        /// <param name="username">
        ...
        /// <summary>
        ///     Resets a user's password to a new, automatically generated 
        ///     password.
        /// </summary>
        /// <returns>
        ///     The new password for the specified user.
        ...
        /// <param name="user">
        ///     A <see cref="T:System.Web.Security.MembershipUser" /> object 
        ///     that represents the user to update and the updated information 
        ///     for the user. 
        /// </param>
        ...
        /// <summary>
        ///     Verifies that the specified user name and password exist in the 
        ///     data source.
        /// </summary>
        /// <returns>
        ...
        /// </summary>
        /// <returns>
        ///     [true] if the membership user was successfully unlocked; 
        ///     otherwise, [false].
        /// </returns>
        /// <param name="userName">
        ...
        /// <returns>
        ///     A <see cref="T:System.Web.Security.MembershipUser" /> object 
        ///     populated with the specified user's information from the data 
        ///     source.
        /// </returns>
        /// <param name="providerUserKey">
        ///     The unique identifier for the membership user to get information
        ///     for.
        /// </param>
        /// <param name="userIsOnline">
        ///     [true] to update the last-activity date/time stamp for the user;
        ///     [false] to return user information without updating the 
        ...
        /// <summary>
        ///     Gets information from the data source for a user. Provides an 
        ///     option to update the last-activity date/time stamp for the user.
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Web.Security.MembershipUser" /> object 
        ///     populated with the specified user's information from the 
        ///     data source.
        /// </returns>
        /// <param name="username">
        ...
        ///     [true] to delete data related to the user from the database; 
        ///     [false] to leave data related to the user in the database.
        /// </param>
        ...
        /// <summary>
        ///     Gets a collection of all the users in the data source in pages 
        ///     of data.
        /// </summary>
        /// <returns>
        ...
        ///     beginning at the page specified by 
        ...
        {
            return this.dataService.GetAllUsers(this.Name, 0, 100, out totalRecords);
        }
